(function () {
  const projectName = 'Casa Brasa Barcelona';
  const projectUrl = 'https://alxnrocha.github.io/casa-brasa-barcelona/';
  const description = 'CardÃ¡pio Digital & Sistema de Pedidos GastronÃ´micos';
